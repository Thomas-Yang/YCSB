...
class WarmupThread extends ClientThread {
    ...
    private long curexec;

    public WarmupThread(DB db, boolean dotransactions, Workload workload, Properties props, int opcount, double targetperthreadperms, CountDownLatch completeLatch, long exectime) {
        super(db, dotransactions, workload, props, opcount, targetperthreadperms, completeLatch);
...
public class Client {
    ...
    /**
     * The maximum amount of warmp up operations.
     */
    public static final String WARMUP_OPERATION_COUNT_PROPERTY = "warmupoperationcount";
    /**
     * The maximum amount of time (in seconds) for warming up.
     */
