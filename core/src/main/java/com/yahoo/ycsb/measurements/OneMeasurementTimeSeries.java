...
import edu.umich.clarity.JVMProfiler;
...
public class OneMeasurementTimeSeries extends OneMeasurement {
    ...
    public OneMeasurementTimeSeries(String name, Properties props) {
        ...
        _gcstatistics = new Vector<String>();
        jvmProfiler = new JVMProfiler(props.getProperty(JVMIDENTIFIER));
    }
    ...
    void checkEndOfUnit(boolean forceend) {
        ...
        if ((unit > currentunit) || (forceend)) {
            ...
            _gcstatistics.add(jvmProfiler.gcProfile());
    ...
    public void exportMeasurements(MeasurementsExporter exporter) throws IOException {
        ...
        for (int i = 0; i < _measurements.size(); i++) {
            ...
            String gcStat = _gcstatistics.get(i);
            exporter.write(getName(), Long.toString(unit.time) + "_" + gcStat, unit.average);
        }
